...
// (B) COMPANY
$this->data .= "<table id='company'><tr><td>";
// Use file path for PDF (index 1), not URL (index 0)
if (!empty($this->company[1]) && file_exists($this->company[1])) {
    $this->data .= "<img src='".$this->company[1]."'/>";
}
$this->data .= "</td><td class='right'>";
