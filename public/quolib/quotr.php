...
class Quotr {
  ...
  private $pathV = null; // Will be set to Laravel's vendor path
  ...
  // Constructor to set vendor path
  function __construct() {
    // Use Laravel's base vendor path
    $this->pathV = dirname(dirname(__DIR__)) . DIRECTORY_SEPARATOR . "vendor" . DIRECTORY_SEPARATOR;
  }
